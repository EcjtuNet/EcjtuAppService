...
function randomColor () {
    var palette = [
        ...
        ["#C2185B","#E91E63","#F8BBD0"],
        ["#7B1FA2","#9C27B0","#E1BEE7"],
        ["#512DA8","#673AB7","#D1C4E9"],
        ["#303F9F","#3F51B5","#C5CAE9"],
        ["#1976D2","#2196F3","#BBDEFB"],
        ["#0288D1","#03A9F4","#B3E5FC"],
        ["#0097A7","#00BCD4","#B2EBF2"],
        ["#00796B","#009688","#B2DFDB"],
        ["#388E3C","#4CAF50","#C8E6C9"],
        ["#689F38","#8BC34A","#DCEDC8"],
        ["#AFB42B","#CDDC39","#F0F4C3"],
        ["#FBC02D","#FFEB3B","#FFF9C4"],
        ["#FFA000","#FFC107","#FFECB3"],
        ["#F57C00","#FF9800","#FFE0B2"],
        ["#E64A19","#FF5722","#FFCCBC"]
    ];
